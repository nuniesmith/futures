...
class TestComputeATR:
    ...
    def test_basic_atr(self):
        from lib.trading.strategies.rb.orb import compute_atr
...
class TestComputeOpeningRange:
    ...
    def test_basic_opening_range(self):
        from lib.trading.strategies.rb.orb import compute_opening_range
...
class TestDetectOpeningRangeBreakout:
    ...
    def test_no_breakout(self):
        ...
        from lib.trading.strategies.rb.orb import detect_opening_range_breakout
...
class TestORBResult:
    ...
    def test_to_dict_structure(self):
        from lib.trading.strategies.rb.orb import ORBResult
...
class TestScanORBAllAssets:
    ...
    def test_multiple_symbols(self):
        from lib.trading.strategies.rb.orb import scan_orb_all_assets
...
class TestORBPublishing:
    ...
    def test_publish_success(self):
        from lib.trading.strategies.rb.orb import ORBResult, publish_orb_alert
    ...
    def test_clear_orb_alert(self):
        from lib.trading.strategies.rb.orb import clear_orb_alert
...
class TestORBConstants:
    ...
    def test_or_window(self):
        from lib.trading.strategies.rb.orb import OR_END, OR_START

        assert dt_time(9, 30) == OR_START
        assert dt_time(10, 0) == OR_END

    def test_atr_period(self):
        from lib.trading.strategies.rb.orb import ATR_PERIOD

        assert ATR_PERIOD > 0
        assert ATR_PERIOD <= 30

    def test_breakout_multiplier(self):
        from lib.trading.strategies.rb.orb import BREAKOUT_ATR_MULTIPLIER

        assert BREAKOUT_ATR_MULTIPLIER > 0
        assert BREAKOUT_ATR_MULTIPLIER <= 2.0

    def test_min_or_bars(self):
        from lib.trading.strategies.rb.orb import MIN_OR_BARS

        assert MIN_OR_BARS >= 3

    def test_redis_keys(self):
        from lib.trading.strategies.rb.orb import REDIS_KEY_ORB, REDIS_PUBSUB_ORB
...
class TestMultiSessionORB:
    ...
    def test_detect_all_sessions(self):
        from lib.trading.strategies.rb.orb import detect_all_sessions
    ...
    def test_multi_session_result_properties(self):
        from lib.trading.strategies.rb.orb import MultiSessionORBResult, ORBResult
    ...
    def test_session_helpers(self):
        from lib.trading.strategies.rb.orb import get_active_sessions, get_session_status
