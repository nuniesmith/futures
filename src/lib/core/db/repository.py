...
import asyncio
from typing import TypeVar, Generic, Type, List, Dict, Any, Optional, Union, Tuple, Callable
...
from src.lib.core.exceptions.data import (
    DatabaseError, 
    DatabaseQueryError, 
    DataNotFoundError,
...
class Pagination:
    ...
    def __init__(self, page: int = 1, page_size: int = 50, order_by: Optional[str] = None, 
                 order_dir: str = "ASC"):
        """
...
class BaseRepository(Generic[T, ID]):
    ...
    def __init__(self, db: Database, model_cls: Type[T], table_name: Optional[str] = None,
                 id_field: str = "id", timestamps: bool = True, 
                 created_at_field: str = "created_at", updated_at_field: str = "updated_at"):
        """
    ...
    async def find_all(self, filter: Optional[QueryFilter] = None, 
                       pagination: Optional[Pagination] = None) -> PaginatedResult[T]:
        """
    ...
    async def execute_raw(self, query: str, params: List[Any] = []) -> List[Dict[str, Any]]:
        """
