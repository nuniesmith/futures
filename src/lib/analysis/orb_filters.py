"""
Opening Range Breakout Filters — Quality-over-Quantity Gate
============================================================
Research-backed filters that sit between the ORB detector (orb.py) and
...
class ORBFilterResult:
    """Composite result from running all ORB filters."""
