...
class SMA(Indicator):
    ...
    def __init__(self, name: str = "SMA", params: Optional[Dict[str, Any]] = None):
        """
...
class EMA(Indicator):
    ...
    def __init__(self, name: str = "EMA", params: Optional[Dict[str, Any]] = None):
        """
...
class WMA(Indicator):
    ...
    def __init__(self, name: str = "WMA", params: Optional[Dict[str, Any]] = None):
        """
