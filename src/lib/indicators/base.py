...
from core.component.base import Component
from core.validation.validation import validate_dataframe
...
class Indicator(Component, ABC):
    ...
    def get_value(self, index: int = -1) -> Union[float, Dict[str, float]]:
        """
    ...
    def get_series(self, column: Optional[str] = None) -> pd.Series:
        """
