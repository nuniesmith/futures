...
class KeltnerChannelsIndicator:
    ...
    def _calculate_keltner_channels(self, data: pd.DataFrame) -> pd.DataFrame:
        ...
        self.logger.info(f"Calculating Keltner Channels with period_ema={self.period_ema} and multiplier_atr={self.multiplier_atr}.")
    ...
    def update(self, data_point: dict) -> Optional[dict]:
        ...
        try:
            ...
            if high is None or low is None or close is None:
                self.logger.warning("Data point missing required 'high', 'low', or 'close' for Keltner Channels update.")
                return None
