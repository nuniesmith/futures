"""
lib.training — CNN training, dataset generation, and simulation modules.
...
so that importing ``lib.training`` on a CPU-only deployment doesn't pull
...
Usage::
    ...
    from lib.training.dataset_generator import (
        generate_dataset,
        DatasetConfig,
        DatasetStats,
    )
