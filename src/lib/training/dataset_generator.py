...
class DatasetConfig:
    ...
    # Data source
    # "massive"— call Massive REST API directly (preferred; requires
    #             MASSIVE_API_KEY in env or .env file)
    # "db"     — read from Postgres/SQLite historical_bars table
    # "cache"  — read from Redis (short-lived, limited history)
    # "csv"    — read from local CSV files (offline/test use)
    bars_source: str = "massive"  # "massive" | "db" | "cache" | "csv"
...
def _bracket_configs_for_session(
    ...
    """
    from lib.training.orb_simulator import BracketConfig
...
def _run_simulators_for_breakout_type(
    ...
    from lib.training.orb_simulator import (
        BracketConfig,
        simulate_batch,
