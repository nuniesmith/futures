"""
futures_lib.analysis — Market analysis and signal modules.

Re-exports the public API from each sub-module so callers can do:

    from src.futures_lib.analysis import compute_cvd, detect_fvgs, kmeans_volatility_clusters
"""

from src.futures_lib.analysis.confluence import (
...
from src.futures_lib.analysis.monte_carlo import (
    compute_confidence_cones,
    run_monte_carlo,
)
from src.futures_lib.analysis.regime import (
    RegimeDetector,
    detect_regime_hmm,
    fit_detector,
)
