...
from src.futures_lib.analysis.confluence import (  # noqa: E402
    check_confluence,
    get_recommended_timeframes,
)
from src.futures_lib.analysis.cvd import compute_cvd, cvd_summary  # noqa: E402
from src.futures_lib.analysis.ict import ict_summary  # noqa: E402
from src.futures_lib.analysis.scorer import (  # noqa: E402
    PreMarketScorer,
    score_instruments,
)
from src.futures_lib.analysis.scorer import (
    results_to_dataframe as scorer_to_dataframe,  # noqa: E402
)
from src.futures_lib.core.cache import (  # noqa: E402
    REDIS_AVAILABLE,
    _cache_key,
    cache_get,
...
from src.futures_lib.integrations.grok_helper import (  # noqa: E402
    GrokSession,
    _escape_dollars,
...
class DataServiceClient:
    ...
    def get_latest_all(self, interval: str = "5m", period: str = "5d") -> Any:
        return self._get(
    ...
    def get_backtest_results(self) -> Any:
        return self._get("/analysis/backtest_results")

    def get_strategy_history(self) -> Any:
        return self._get("/analysis/strategy_history")

    def get_live_feed_status(self) -> Any:
    ...
    def start_live_feed(self) -> Any:
        return self._post("/actions/live_feed/start")

    def stop_live_feed(self) -> Any:
    ...
    def resolve_contract(self, ticker: str) -> Any:
    ...
    def get_contract(self, ticker: str) -> Any:
    ...
    def list_products(self, **kwargs) -> Any:
    ...
    def get_product(self, product_code: str) -> Any:
    ...
    def get_snapshots_bulk(self, tickers: list[str]) -> Any:
    ...
    def get_market_status(self, product_code: str | None = None) -> Any:
