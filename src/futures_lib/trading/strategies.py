...
def _compute_ict_confluence(
    ...
    try:
        from src.futures_lib.analysis.ict import get_active_order_blocks, get_unfilled_fvgs
    except ImportError:
        return result
    ...
    from src.futures_lib.analysis.ict import _atr as ict_atr
...
try:
    from src.futures_lib.analysis.volume_profile import VolumeProfileStrategy as _VPS
